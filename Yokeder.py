...
print('...Yok eder Scriptini kullandığınız için teşekkürler web sitemizi ziyaret etmeyi unutmayın!!! :bilgisayaradair.ml')

usage ="""############# HELP #################

python Yokeder.py tcp  ip port flag count

python Yokeder.py udp  ip port count

python Yokeder.py icmp ip count
